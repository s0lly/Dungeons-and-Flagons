...
public:
	...
	void DrawSpriteScaledUp(int x, int y, const Surface& s, int scale, Color chroma = Colors::Magenta);
	void DrawSpriteScaledUp(int x, int y, const RectI& srcRect, const Surface& s, int scale, Color chroma = Colors::Magenta);
	void DrawSpriteScaledUp(int x, int y, RectI srcRect, const RectI& clip, const Surface& s, int scale, Color chroma = Colors::Magenta);
